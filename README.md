# TheScientificArtist.org

Static authorship archive for **The Scientific Artist** by Rohan Chaudri.
...
- Point `TheScientificArtist.org` at this site.
- Public platform URLs from KingOfFremont.com are populated.
